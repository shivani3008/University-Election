<%@ Page Title="" Language="C#" MasterPageFile="~/stu_masterpage_after.master" AutoEventWireup="true" CodeFile="stu_live_result - Copy.aspx.cs" Inherits="stu_live_result" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3 class="center-align">Live Result</h3>
                                ...
                                <blockquote>
                                    <div class="row">
                                        ...
                                        <div class="col l9">
                                            ...
                                            <div class="row">
                                                <div class="col l12">
                                                    <asp:Label ID="lbl_total_votes" runat="server" Text='<%#Bind("total_votes") %>'></asp:Label>&nbsp;
                                                </div>
                                            </div>
                                        </div>
                                    </div>
