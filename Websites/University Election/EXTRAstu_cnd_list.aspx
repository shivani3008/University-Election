<%@ Page Title="" Language="C#" MasterPageFile="~/stu_masterpage_after.master" AutoEventWireup="true" CodeFile="EXTRAstu_cnd_list.aspx.cs" Inherits="stu_login" %>
                ...
                <ItemTemplate>
                    <div class="row card">
                        <div class="input-field col s4 m4 l4">
                            <asp:Image ID="img_profile_photo" runat="server"  Height="75px" 
                            ImageUrl='<%# Bind("profile_photo") %>' Width="75px"/>
                        </div>
                        <div class="input-field col s8 m8 l8">
                            ...
                            <div class="row">
                                <div class="right input-field col s12 m12 l12">
                                    <asp:LinkButton ID="lbtn" runat="server" CommandName="OnMore" CommandArgument='<%#Bind("cnd_id") %>'><b>View More Details</b></asp:LinkButton></td>
                                </div>
                            </div>
                        </div>
                    </div>
